	...
	public final ImmutableMethodReference fully_qualified_method() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    methodReference = new ImmutableMethodReference((reference_type_descriptor77!=null?((reference_type_descriptor_return)reference_type_descriptor77).type:null), (SIMPLE_NAME78!=null?SIMPLE_NAME78.getText():null),
	...
	public final ImmutableFieldReference fully_qualified_field() throws RecognitionException {
		...
		try {
			...
			state._fsp--;
			    ...
			    fieldReference = new ImmutableFieldReference((reference_type_descriptor80!=null?((reference_type_descriptor_return)reference_type_descriptor80).type:null), (SIMPLE_NAME81!=null?SIMPLE_NAME81.getText():null),
		...
		try {
			...
			switch (alt35) {
				...
				case 2 :
					...
					type = (nonvoid_type_descriptor181!=null?((nonvoid_type_descriptor_return)nonvoid_type_descriptor181).type:null);
					}
					break;
	...
	public final Annotation annotation() throws RecognitionException {
		...
		try {
			...
			match(input, Token.UP, null); 
			      ...
			      annotation = new ImmutableAnnotation(visibility, (subannotation203!=null?((subannotation_return)subannotation203).annotationType:null), (subannotation203!=null?((subannotation_return)subannotation203).elements:null));
